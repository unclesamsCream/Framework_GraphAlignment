...
def alhpa(src_graph, tar_graph, rsc=0, weighting_scheme='ncut', lap=False, gt=None, ki=False, lalpha=10000, n_comp=10, n_threads=8):
    """
...
def main(data, eta, rsc, lap, ki, lalpha, weighting_scheme, n_comp, n_threads):
    ...
    matching, pos, readj_accs = alhpa(*run_args)
